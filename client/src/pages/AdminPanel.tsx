            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  { label: "Brevo", value: emailConfig?.brevoConfigured ? "Configurado" : "Não configurado", color: emailConfig?.brevoConfigured ? "text-emerald-600" : "text-slate-400" },
                  { label: "SMTP (fallback)", value: emailConfig?.smtpConfigured ? "Configurado" : "Não configurado", color: emailConfig?.smtpConfigured ? "text-emerald-600" : "text-slate-400" },
